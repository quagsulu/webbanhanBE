...
export const returnResultPayment = async (req, res, next) => {
  try {
...
//   let vnp_RequestId = dayjs(date).format('[YYYYescape] YYYY-MM-DDTHH:mm:ssZ[Z]')
...
//   let currCode = 'VND'
//   let vnp_CreateDate = dayjs(date).format(
